...
window.getStoredThemePreference = function () {
    return window.themeManager.getStoredTheme() || window.themeManager.getSystemTheme();
};

window.setThemePreference = function (themeName) {
    var normalized = window.themeManager.normalizeTheme(themeName) || window.themeManager.getSystemTheme();
    window.themeManager.setStoredTheme(normalized);
    window.themeManager.applyTheme(normalized);
    return normalized;
};
