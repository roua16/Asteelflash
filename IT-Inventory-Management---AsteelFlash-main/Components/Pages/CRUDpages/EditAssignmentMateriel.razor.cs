...
namespace ITStockM.Components.Pages.CrudPages
{
    public partial class EditAssignmentMateriel
    {
        ...
        {
            assignmentMateriel = await AssignmentMaterielService.GetAssignmentMaterielByMaterielIdAndAssignmentId(MaterielId, AssignmentId) ?? new Domain.Entities.AssignmentMateriel();
