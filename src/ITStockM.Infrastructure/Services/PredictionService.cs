...
namespace ITStockM.Services.Prediction
{
    ...
    public class PredictionService : IPredictionService
    {
        ...
        private AssetPrediction BuildPrediction(Materiel m)
        {
            ...
            var closedTickets    = m.MaintenanceTickets?.Count(t => t.Status == MaintenanceTicketStatus.Closed) ?? 0;
            var openTickets      = m.MaintenanceTickets?.Count(t => t.Status != MaintenanceTicketStatus.Closed) ?? 0;
